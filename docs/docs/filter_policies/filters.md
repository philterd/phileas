...
A selection of filters and their configurations is called a [policy](filter_policies.md). A policy describes how to
...
| [Bank Routing Numbers](filters/common_filters/bank-routing-numbers.md)     | Identifies bank routing numbers                                                 |
