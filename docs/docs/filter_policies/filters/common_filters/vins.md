...
This filter identifies 17-digit vehicle identification numbers (VINs) such as `WBAPM7G50ANL19218` and
`1GBJC34K3RE176005` in text.
...
|-----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| `vinFilterStrategies` | A list of filter strategies.                                                                                                                                                                                 | None                                                     |
