...
|-----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| `einFilterStrategies` | A list of filter strategies.                                                                                                                                                                                 | None                                                     |
| `onlyValidPrefixes`   | When `true`, only detect EINs whose two-digit prefix is one the IRS currently issues. This reduces false positives on format-valid but non-issued numbers. A prefix added by the IRS after this release is recognized only once the engine's prefix list is updated. | `false`                                                  |
