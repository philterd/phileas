...
In Philter's filter strategies, replacement is achieved by using the strategy to `REDACT`, `STATIC_REPLACE` , or `RANDOM_REPLACE` . To replace values from a lookup table you provide, see [Mapped Replacement](mapped-replacement.md).
