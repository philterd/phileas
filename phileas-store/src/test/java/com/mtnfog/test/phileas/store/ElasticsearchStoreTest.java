...
public class ElasticsearchStoreTest {
    ...
    private static final String ELASTICSEARCH_HOST = "build.mtnfog.com";
    ...
    public void test2() throws IOException, InterruptedException {
        ...
        final ElasticsearchStore store = new ElasticsearchStore(INDEX_NAME, "http", ELASTICSEARCH_HOST, PORT);
