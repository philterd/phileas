...
import ai.philterd.phileas.services.anonymization.faker.service.FakerIDN;
...
public class Internet {
    ...
    /**
     * @return a slug using '_' as the word separator and two {@link ai.philterd.phileas.services.anonymization.faker.Lorem} words as the values
     */
    public String slug() {
