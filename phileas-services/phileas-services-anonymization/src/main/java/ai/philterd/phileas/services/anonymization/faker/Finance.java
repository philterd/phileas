...
public class Finance {
    ...
    public String creditCard(ai.philterd.phileas.services.anonymization.faker.CreditCardType creditCardType) {
    ...
    public String creditCard() {
        ai.philterd.phileas.services.anonymization.faker.CreditCardType type = randomCreditCardType();
    ...
    private ai.philterd.phileas.services.anonymization.faker.CreditCardType randomCreditCardType() {
        return ai.philterd.phileas.services.anonymization.faker.CreditCardType.values()[this.faker.random().nextInt(CreditCardType.values().length)];
    }
