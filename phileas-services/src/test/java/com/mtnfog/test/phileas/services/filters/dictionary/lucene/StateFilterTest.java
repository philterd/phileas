...
public class StateFilterTest extends AbstractFilterTest {
    ...
    public void filterStatesLow() throws IOException {
        ...
        final LuceneDictionaryFilter filter = new LuceneDictionaryFilter(FilterType.LOCATION_STATE, strategies, INDEX_DIRECTORY, LuceneDictionaryFilter.getStatesDistances(), anonymizationService);
