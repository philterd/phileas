...
public class PartOfSpeechFalsePositiveFilterTest {
    ...
    public void filter2() throws Exception {
        ...
        final List<Span> spans = new LinkedList<>();
        spans.add(Span.make(3, 8, FilterType.LOCATION_STATE, "context", "docid", 0.80, "test", "*****", false, new String[0]));
    ...
    public void filter3() throws Exception {
        ...
        final List<Span> spans = new LinkedList<>();
        spans.add(Span.make(0, 17, FilterType.NER_ENTITY, "context", "docid", 0.80, "test", "*****", false, new String[0]));
