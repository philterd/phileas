...
public class IdentifierFilterTest extends FilterTest {
    ...
    public void filterId1() throws Exception {
        ...
        IdentifierFilter filter = new IdentifierFilter("name", Identifier.DEFAULT_IDENTIFIER_REGEX, true, strategies, anonymizationService, Collections.emptySet(), new Crypto());
    ...
    public void filterId13() throws Exception {
        ...
        final List<IdentifierFilterStrategy> strategies = Arrays.asList(new IdentifierFilterStrategy());
        IdentifierFilter filter = new IdentifierFilter("name", "\\b[A-Z]{4,}\\b", true, strategies, anonymizationService, Collections.emptySet(), new Crypto());
