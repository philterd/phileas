...
public class SpanDisambiguationServiceTest {
    ...
    public void test1() {
        ...
        final Span span1 = Span.make(0, 4, FilterType.SSN, "c", "d", 0.00, "123-45-6789", "000-00-0000", false, new String[]{"ssn", "was", "he", "was"});
        ...
        final Span ambiguousSpan = Span.make(0, 4, FilterType.SSN, "c", "d", 0.00, "123-45-6789", "000-00-0000", false, new String[]{"phone", "number", "he", "was"});
