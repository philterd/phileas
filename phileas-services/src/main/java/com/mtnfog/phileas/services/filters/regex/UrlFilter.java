...
public class UrlFilter extends RegexFilter implements Serializable {
    ...
    public UrlFilter(List<? extends AbstractFilterStrategy> strategies, AnonymizationService anonymizationService) {
        super(FilterType.URL, strategies, anonymizationService);
    }
