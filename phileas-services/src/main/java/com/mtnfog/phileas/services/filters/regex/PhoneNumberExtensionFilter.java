...
public class PhoneNumberExtensionFilter extends RegexFilter implements Serializable {
    ...
    public PhoneNumberExtensionFilter(List<? extends AbstractFilterStrategy> strategies, AnonymizationService anonymizationService) {
        super(FilterType.PHONE_NUMBER_EXTENSION, strategies, anonymizationService);
    }
