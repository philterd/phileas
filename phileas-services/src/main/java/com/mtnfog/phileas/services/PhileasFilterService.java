...
public class PhileasFilterService implements FilterService, Serializable {
    ...
    @Override
    public FilterResponse filter(String filterProfileName, String context, String input) throws InvalidFilterProfileException, Exception {
        ...
        final List<Filter> allFiltersFromProfile = filters.get(filterProfileName);
