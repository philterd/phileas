package io.philterd.phileas.model.profile.filters.strategies.custom;
...
public class CustomDictionaryFilterStrategy extends AbstractFilterStrategy {
    ...
    private static final Logger LOGGER = LogManager.getLogger(io.philterd.phileas.model.profile.filters.strategies.custom.CustomDictionaryFilterStrategy.class);
