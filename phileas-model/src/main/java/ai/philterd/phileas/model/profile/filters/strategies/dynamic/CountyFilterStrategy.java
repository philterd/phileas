package ai.philterd.phileas.model.profile.filters.strategies.dynamic;
...
public class CountyFilterStrategy extends AbstractFilterStrategy {

    private static final Logger LOGGER = LogManager.getLogger(CountyFilterStrategy.class);

    private static FilterType filterType = FilterType.LOCATION_COUNTY;
