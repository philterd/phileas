...
public class CountyFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-county", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-county}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:county>token</ENTITY>", replacement);
