...
public class IbanCodeFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-iban-code", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-iban-code}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:iban-code>token</ENTITY>", replacement);
