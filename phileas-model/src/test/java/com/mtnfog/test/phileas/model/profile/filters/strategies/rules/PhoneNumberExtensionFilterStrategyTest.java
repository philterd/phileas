...
public class PhoneNumberExtensionFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-phone-number-extension", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-phone-number-extension}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:phone-number-extension>token</ENTITY>", replacement);
