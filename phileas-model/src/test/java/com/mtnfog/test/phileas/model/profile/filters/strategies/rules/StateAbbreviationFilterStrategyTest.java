...
public class StateAbbreviationFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assert.assertEquals("REDACTION-state-abbreviation", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assert.assertEquals("{{{REDACTED-state-abbreviation}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assert.assertEquals("<ENTITY:state-abbreviation>token</ENTITY>", replacement);
