...
public class StateAbbreviationFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-state-abbreviation", replacement.getReplacement());
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-state-abbreviation}}}", replacement.getReplacement());
    ...
    public void replacement5() throws Exception {
        ...
        final AbstractFilterStrategy strategy = new StateAbbreviationFilterStrategy();
        strategy.setStrategy(AbstractFilterStrategy.REDACT);
        strategy.setRedactionFormat("<ENTITY:%t>%v</ENTITY>");

        final Replacement replacement = strategy.getReplacement("name", "context", "docId", "token", new Crypto(), anonymizationService);

        Assertions.assertEquals("<ENTITY:state-abbreviation>token</ENTITY>", replacement.getReplacement());
