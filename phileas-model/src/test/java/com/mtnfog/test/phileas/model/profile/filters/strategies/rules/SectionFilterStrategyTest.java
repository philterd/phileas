...
public class SectionFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-section", replacement.getReplacement());
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-section}}}", replacement.getReplacement());
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:section>token</ENTITY>", replacement.getReplacement());
