...
public class IpAddressFilterStrategyTest {
    ...
    public void replacement1() throws Exception {
        ...
        final IpAddressFilterStrategy strategy = new IpAddressFilterStrategy();
    ...
    public void replacement2() throws Exception {
        ...
        Assert.assertEquals("REDACTION-ip-address", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assert.assertEquals("{{{REDACTED-ip-address}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        final AbstractFilterStrategy strategy = new IpAddressFilterStrategy();
        strategy.setStrategy(AbstractFilterStrategy.REDACT);
        strategy.setRedactionFormat("<ENTITY:%t>%v</ENTITY>");

        final String replacement = strategy.getReplacement("name", "context", "docId", "token", new Crypto(), anonymizationService);

        Assert.assertEquals("<ENTITY:ip-address>token</ENTITY>", replacement);
