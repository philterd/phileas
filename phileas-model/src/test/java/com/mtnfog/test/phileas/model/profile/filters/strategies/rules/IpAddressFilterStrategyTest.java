...
public class IpAddressFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-ip-address", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-ip-address}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:ip-address>token</ENTITY>", replacement);
