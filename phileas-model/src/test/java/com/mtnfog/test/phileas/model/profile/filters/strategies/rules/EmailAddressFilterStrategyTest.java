...
public class EmailAddressFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-email-address", replacement.getReplacement());
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-email-address}}}", replacement.getReplacement());
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:email-address>token</ENTITY>", replacement.getReplacement());
