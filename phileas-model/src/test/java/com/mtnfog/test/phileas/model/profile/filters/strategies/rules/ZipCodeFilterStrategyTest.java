...
public class ZipCodeFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-zip-code", replacement.getReplacement());
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-zip-code}}}", replacement.getReplacement());
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:zip-code>token</ENTITY>", replacement.getReplacement());
