...
public class PhoneNumberFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-phone-number", replacement);
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-phone-number}}}", replacement);
    ...
    public void replacement5() throws Exception {
        ...
        Assertions.assertEquals("<ENTITY:phone-number>token</ENTITY>", replacement);
