...
public class PhoneNumberFilterStrategyTest {
    ...
    public void replacement2() throws Exception {
        ...
        Assertions.assertEquals("REDACTION-phone-number", replacement.getReplacement());
    ...
    public void replacement4() throws Exception {
        ...
        Assertions.assertEquals("{{{REDACTED-phone-number}}}", replacement.getReplacement());
    ...
    public void replacement5() throws Exception {
        ...
        final AbstractFilterStrategy strategy = new PhoneNumberFilterStrategy();
        strategy.setStrategy(AbstractFilterStrategy.REDACT);
        strategy.setRedactionFormat("<ENTITY:%t>%v</ENTITY>");

        final Replacement replacement = strategy.getReplacement("name", "context", "docId", "token", new Crypto(), anonymizationService);

        Assertions.assertEquals("<ENTITY:phone-number>token</ENTITY>", replacement.getReplacement());
