...
Phileas is the underlying core of [Philter](https://www.philter.ai/philter/), a turnkey text redaction engine which is built on top of Phileas and provides an API for redacting text. Philter runs entirely within your cloud and never transmits data outside of your cloud. Custom AI models are available for domains like healthcare, legal, and news.
...
* On-prem deployments by contacting us at [https://www.philter.ai/](https://www.philter.ai). 

Phileas also powers [Airlock](https://www.philter.ai/airlock), an AI policy layer to prevent the disclosure of sensitive information, such as PII and PHI, in your AI applications.
