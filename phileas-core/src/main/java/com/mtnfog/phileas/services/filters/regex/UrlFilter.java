...
public class UrlFilter extends RegexFilter {
    ...
    public UrlFilter(List<? extends AbstractFilterStrategy> strategies, AnonymizationService anonymizationService, AlertService alertService, boolean requireHttpWwwPrefix, Set<String> ignored, Crypto crypto, int windowSize) {
        ...
        final FilterPattern url1 = new FilterPattern.FilterPatternBuilder(URL_WITH_OPTIONAL_PROTOCOL_REGEX, 0.10).build();
        ...
        final FilterPattern url2 = new FilterPattern.FilterPatternBuilder(URL_WITH_PROTOCOL_REGEX, 0.80).build();
        ...
        final FilterPattern url3 = new FilterPattern.FilterPatternBuilder(URL_IPV4_ADDRESS_REGEX, 0.80).build();
        ...
        final FilterPattern url4 = new FilterPattern.FilterPatternBuilder(URL_IPV6_ADDRESS_REGEX, 0.80).build();
