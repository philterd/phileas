...
public class UrlFilterTest extends AbstractFilterTest {
    ...
    public void filterUrl1() throws Exception {
        ...
        UrlFilter filter = new UrlFilter(strategies, new UrlAnonymizationService(new LocalAnonymizationCacheService()), true, Collections.emptySet(), new Crypto(), windowSize);
    ...
    public void filterUrl6() throws Exception {
        ...
        final List<UrlFilterStrategy> strategies = Arrays.asList(new UrlFilterStrategy());
        UrlFilter filter = new UrlFilter(strategies, new UrlAnonymizationService(new LocalAnonymizationCacheService()), false, Collections.emptySet(), new Crypto(), windowSize);
