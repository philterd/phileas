package io.philterd.test.phileas.services;

import io.philterd.phileas.model.profile.FilterProfile;
import io.philterd.phileas.model.profile.Identifiers;
import io.philterd.phileas.model.profile.Ignored;
import io.philterd.phileas.model.profile.filters.Age;
import io.philterd.phileas.model.profile.filters.City;
import io.philterd.phileas.model.profile.filters.County;
import io.philterd.phileas.model.profile.filters.CreditCard;
import io.philterd.phileas.model.profile.filters.CustomDictionary;
import io.philterd.phileas.model.profile.filters.Date;
import io.philterd.phileas.model.profile.filters.EmailAddress;
import io.philterd.phileas.model.profile.filters.FirstName;
import io.philterd.phileas.model.profile.filters.Hospital;
import io.philterd.phileas.model.profile.filters.HospitalAbbreviation;
import io.philterd.phileas.model.profile.filters.Identifier;
import io.philterd.phileas.model.profile.filters.IpAddress;
import io.philterd.phileas.model.profile.filters.Person;
import io.philterd.phileas.model.profile.filters.PhoneNumber;
import io.philterd.phileas.model.profile.filters.Ssn;
import io.philterd.phileas.model.profile.filters.State;
import io.philterd.phileas.model.profile.filters.StateAbbreviation;
import io.philterd.phileas.model.profile.filters.Surname;
import io.philterd.phileas.model.profile.filters.Url;
import io.philterd.phileas.model.profile.filters.Vin;
import io.philterd.phileas.model.profile.filters.ZipCode;
...
import io.philterd.phileas.model.profile.filters.strategies.rules.ZipCodeFilterStrategy;
