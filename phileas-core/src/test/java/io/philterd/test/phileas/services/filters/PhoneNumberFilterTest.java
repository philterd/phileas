...
public class PhoneNumberFilterTest extends AbstractFilterTest {
    ...
    public void filterPhone1() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is (123) 456-7890.");
    ...
    public void filterPhone2() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is (123) 456-7890 and (123) 456-7890.");
    ...
    public void filterPhone4() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is 123-456-7890 and he was ok.");
        Assertions.assertEquals(1, filterResult.getSpans().size());
        Assertions.assertTrue(checkSpan(filterResult.getSpans().get(0), 14, 26, FilterType.PHONE_NUMBER));
    ...
    public void filterPhone5() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is ( 800 ) 123-4567 and he was ok.");
        Assertions.assertEquals(1, filterResult.getSpans().size());
    ...
    public void filterPhone6() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is (800) 123-4567 x532 and he was ok.");
    ...
    public void filterPhone7() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "the number is (800) 123-4567x532 and he was ok.");
        showSpans(filterResult.getSpans());
    ...
    public void filterPhone8() throws Exception {
        ...
        final FilterResult filterResult = filter.filter(getFilterProfile(), "context", "documentid", PIECE, "7 64116-3220");
        showSpans(filterResult.getSpans());
