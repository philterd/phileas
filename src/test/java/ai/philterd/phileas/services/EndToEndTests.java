...
public class EndToEndTests {
    ...
    public void endToEnd1() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "George Washington was president and his ssn was 123-45-6789 and he lived at 90210.", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd2() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "My email is test@something.com and cc is 4121742025464465", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd3() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "test@something.com is email and cc is 4121742025464465", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd4() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "test@something.com", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd5() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "90210", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd6() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "his name was JEFF.", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd7() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "he was seen on 10-19-2020.", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd8() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context",
    ...
    public void endToEnd9() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "George Washington was president and his ssn was 123-45-6789 and he lived at 90210. The name 456 should be filtered. Jeff Smith should be ignored.", MimeType.TEXT_PLAIN);
    ...
    public void endToEnd10() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", input, MimeType.TEXT_PLAIN);
    ...
    public void endToEndUsingCustomDictionary() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "his name was samuel and george.", MimeType.TEXT_PLAIN);
    ...
    public void endToEndUsingCustomDictionaryFileBloomFilter() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "his name was samuel.", MimeType.TEXT_PLAIN);
    ...
    public void endToEndMultiplePolicies() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "My email is test@something.com", MimeType.TEXT_PLAIN);
    ...
    public void endToEndJustCreditCard() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "My cc is 4121742025464465", MimeType.TEXT_PLAIN);
    ...
    public void endToEndJustCreditCardInUnixTimestamp() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "My cc is 1647725122227", MimeType.TEXT_PLAIN);
    ...
    public void endToEndJustCreditCardWithIgnoredTerms() throws Exception {
        ...
        final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
        final FilterResponse response = service.filter(policy, "context", "My cc is 4121742025464400", MimeType.TEXT_PLAIN);
    ...
    public void endToEndNonexistentPolicy() throws Exception {
        ...
        Assertions.assertThrows(FileNotFoundException.class, () -> {
            ...
            final PhileasFilterService service = new PhileasFilterService(phileasConfiguration, contextService, vectorService);
            service.filter(policy, "context", "My email is test@something.com", MimeType.TEXT_PLAIN);
