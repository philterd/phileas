...
public class TrailingNewLinePostFilterTest extends AbstractFilterTest {
    ...
    public void test1() {
        ...
        spans.add(Span.make(12, 22, FilterType.URL, "context", 0.80, "ends with" + System.lineSeparator(), "*****",  "", false, true, new String[0], 0));
    ...
    public void test2() {
        ...
        final List<Span> spans = new LinkedList<>();
        spans.add(Span.make(12, 22, FilterType.URL, "context", 0.80, "ends with", "*****",  "", false, true, new String[0], 0));
    ...
    public void test3() {
        ...
        final List<Span> spans = new LinkedList<>();
        spans.add(Span.make(12, 22, FilterType.URL, "context", 0.80, "ends with" + System.lineSeparator() + System.lineSeparator(), "*****",  "", false, true, new String[0], 0));
