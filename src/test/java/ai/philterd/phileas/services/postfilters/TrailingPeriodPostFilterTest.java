...
public class TrailingPeriodPostFilterTest extends AbstractFilterTest {
    ...
    public void test1() {
        ...
        spans.add(Span.make(12, 22, FilterType.URL, "context", 0.80, "link.test.", "*****",  "", false, true, new String[0], 0));
    ...
    public void test3() {
        ...
        final List<Span> spans = new LinkedList<>();
        spans.add(Span.make(12, 22, FilterType.STREET_ADDRESS, "context", 0.80, "4 Devonshire Ct.", "*****",  "", false, true, new String[0], 0));
