...
/**
 * Single-threaded redactor using the Phileas PII engine.
 */
public class Redactor {
    ...
    public Redactor(String name) throws Exception {
        ...
        this.filterService = new PlainTextFilterService(configuration,
                new DefaultContextService(), new InMemoryVectorService(), null);
    }

    public TextFilterResult filter(String s) throws Exception {
        return filterService.filter(policy, "context", s);
    }
