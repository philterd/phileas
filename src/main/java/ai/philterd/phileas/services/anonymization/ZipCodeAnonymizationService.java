...
public class ZipCodeAnonymizationService extends AbstractAnonymizationService {
    ...
    public ZipCodeAnonymizationService(final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public ZipCodeAnonymizationService(final Random random, final List<String> candidates) {
    ...
    public ZipCodeAnonymizationService(final Random random) {
        super(random);
