...
public class LocationsAnonymizationService extends AbstractAnonymizationService {
    ...
    public LocationsAnonymizationService(final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public LocationsAnonymizationService(final Random random, final List<String> candidates) {
    ...
    public LocationsAnonymizationService(final Random random) {
        super(random);
