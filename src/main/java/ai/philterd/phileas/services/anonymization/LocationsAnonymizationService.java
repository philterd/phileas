...
public class LocationsAnonymizationService extends AbstractAnonymizationService {
    ...
    public LocationsAnonymizationService(final SecureRandom random, final AnonymizationMethod anonymizationMethod) {
    ...
    public LocationsAnonymizationService(final SecureRandom random, final List<String> candidates) {
    ...
    public LocationsAnonymizationService(final SecureRandom random) {
        super(random);
    ...
    public LocationsAnonymizationService() {
        super();
