...
public class FirstNameAnonymizationService extends AbstractAnonymizationService {
    ...
    public FirstNameAnonymizationService(final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public FirstNameAnonymizationService(final Random random, final List<String> candidates) {
    ...
    public FirstNameAnonymizationService(final Random random) {
        super(random);
