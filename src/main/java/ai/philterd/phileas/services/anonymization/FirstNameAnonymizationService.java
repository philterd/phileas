...
public class FirstNameAnonymizationService extends AbstractAnonymizationService {
    ...
    public FirstNameAnonymizationService(final SecureRandom random, final AnonymizationMethod anonymizationMethod) {
    ...
    public FirstNameAnonymizationService(final SecureRandom random, final List<String> candidates) {
    ...
    public FirstNameAnonymizationService(final SecureRandom random) {
        super(random);
    ...
    public FirstNameAnonymizationService() {
        super();
