...
public class PersonsAnonymizationService extends AbstractAnonymizationService {
    ...
    public PersonsAnonymizationService(final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public PersonsAnonymizationService(final Random random, final List<String> candidates) {
    ...
    public PersonsAnonymizationService(final Random random) {
        super(random);
