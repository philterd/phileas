...
public class PersonsAnonymizationService extends AbstractAnonymizationService {
    ...
    private static final Logger LOGGER = LogManager.getLogger(PersonsAnonymizationService.class);

    private DataGenerator dataGenerator;

    public PersonsAnonymizationService(final SecureRandom random, final AnonymizationMethod anonymizationMethod) {
    ...
    public PersonsAnonymizationService(final SecureRandom random, final List<String> candidates) {
    ...
    public PersonsAnonymizationService(final SecureRandom random) {
        super(random);
    ...
    public PersonsAnonymizationService() {
        super();
    ...
    public String anonymize(final String token) {
        ...
        if (anonymizationMethod == AnonymizationMethod.FROM_LIST) {
            ...
            // REALISTIC_REPLACE
            String anonymized = dataGenerator.fullNames().random();

            while (anonymized.equalsIgnoreCase(token)) {
                anonymized = dataGenerator.fullNames().random();
            }
