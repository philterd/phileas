...
public class StateAnonymizationService extends AbstractAnonymizationService {
    ...
    public StateAnonymizationService(final ContextService contextService, final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public StateAnonymizationService(final ContextService contextService, final Random random, final List<String> candidates) {
