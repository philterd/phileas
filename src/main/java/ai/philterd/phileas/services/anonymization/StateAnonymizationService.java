...
public class StateAnonymizationService extends AbstractAnonymizationService {
    ...
    private static final Logger LOGGER = LogManager.getLogger(StateAnonymizationService.class);

    private DataGenerator dataGenerator;

    public StateAnonymizationService(final SecureRandom random, final AnonymizationMethod anonymizationMethod) {
    ...
    public StateAnonymizationService(final SecureRandom random, final List<String> candidates) {
    ...
    public StateAnonymizationService(final SecureRandom random) {
        super(random);
    ...
    public StateAnonymizationService() {
        super();
    ...
    public String anonymize(final String token) {
        ...
        if (anonymizationMethod == AnonymizationMethod.FROM_LIST) {
            ...
            // REALISTIC_REPLACE
            String anonymized = dataGenerator.states().random();

            while (anonymized.equalsIgnoreCase(token)) {
                anonymized = dataGenerator.states().random();
            }
