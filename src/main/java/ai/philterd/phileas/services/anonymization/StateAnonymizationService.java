...
public class StateAnonymizationService extends AbstractAnonymizationService {
    ...
    public StateAnonymizationService(final Random random, final AnonymizationMethod anonymizationMethod) {
    ...
    public StateAnonymizationService(final Random random, final List<String> candidates) {
    ...
    public StateAnonymizationService(final Random random) {
        super(random);
