...
public class EinFilterStrategy extends StandardFilterStrategy {

    private static final Logger LOGGER = LogManager.getLogger(EinFilterStrategy.class);

    private final FilterType filterType = FilterType.EIN;
