...
public class MedicalConditionFilterStrategy extends StandardFilterStrategy {

    private static final Logger LOGGER = LogManager.getLogger(MedicalConditionFilterStrategy.class);

    private final FilterType filterType = FilterType.MEDICAL_CONDITION;
